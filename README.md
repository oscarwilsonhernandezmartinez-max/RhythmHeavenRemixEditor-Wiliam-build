...
# Rhythm Heaven Remix Editor, WiliamBuild (RHREWB)
...
1. Go to the most recent release and download the `RHREWB_X.zip` file, where `X` is the current version number.
...
5. Read the Original [README](http://rhre.readthedocs.io/en/latest/README/) and get remixing!
...
From **v3.19.5 and earlier**: To update the program, download the latest version and run RHRE from the new version.<br>
